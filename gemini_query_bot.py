...
4) 문제 중 코딩테스트의 경우는 파이썬 기준으로 작성을 하고 선지에는 결과 값을 넣거나 작성 코드에 빈칸을 넣어 선지로 선택할 수 있도록 해줘. 복잡한 알고리즘, 자료구조, 시간복잡도 분석이 필요한 문제를 출제해줘.                                                                                                                             
...
5. 예시(주관식 문제)
동적 계획법을 사용하여 0-1 배낭 문제를 해결하는 파이썬 함수를 작성하세요. 가방의 용량은 W, 물건들의 무게는 weights 리스트, 가치는 values 리스트로 주어집니다.

★답: (def knapsack(W, weights, values, n):
